...
```{r}
image( pergm4, ylim = c( 0, 1000 ), xunit="time")
```
...
plot( extractWave( sine6, from = 1, to = 400 ) )
```
...
image( pergm7a, ylim = c( 0, 1000 ), xunit = "time" )
```
...
plot( pergm10, xlim = c( 0, 2000 ), log="y" )
```

```{r}
image( pergm10, ylim = c( 0, 2000 ), xunit="time" )
```
